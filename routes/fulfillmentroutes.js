    ...
    app.post('/', async (req, res) => {
       ...
       async function learn(agent) {
            ...
            let responseText = `You want to learn about ${agent.parameters.courses}. 
                    Here is a link to all of my courses: http://uaf.edu.pk/admissions/un/adm_overview.html `;
        ...
        function fallback(agent) {
            agent.add('I did`nt understand');
            agent.add('I`m sorry, can you try again?');
        }

        let intentMap = new Map(); // for each intent we add a intentamap and a new method
